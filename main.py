...
╱┊┈╱┉▕┉┋╲┈
     ...
     !! Nông Minh Quân!!  
╔══════════════════════════════════╗
  ⚜ https://www.facebook.com/nongminhquan13?mibextid=ZbWKwL 
╚══════════════════════════════════╝

╔══════════════════════════════════╗
   Lưu Ý:                                         
 • Lắp não trước khi sử dụng!!  
 • Để dừng tool bấm CTRL + C   
╚══════════════════════════════════╝
"""
def banner():
  os.system("clear")
...
while not re.search("^(0?)(3[2-9]|5[6|8|9]|7[0|6-9]|8[0-6|8|9]|9[0-4|6-9])[0-9]{7}$",sdt):
  print("SAI ĐỊNH DẠNG")
  sdt = input("Nhập Lại Số Điện Thoại Victim: ")
count = int(input("Nhập Số Lần Muốn Spam [ Nên Nhập 10 ]: "))
if sdt == "0932399207":
  print("Trên đời sao lại có thể loại súc vật mồ côi như này nhỉ !! ")
  quit()
